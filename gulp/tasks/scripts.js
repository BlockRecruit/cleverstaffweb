...
var scriptsFiles = [
	{ filename: cfg.scripts.main.lib.filename, files: cfg.scripts.main.lib.files }
	, { filename: cfg.scripts.main.app.filename, files: cfg.scripts.main.app.files }
	, { filename: cfg.scripts.start.lib.filename, files: cfg.scripts.start.lib.files }
	, { filename: cfg.scripts.start.app.filename, files: cfg.scripts.start.app.files }
