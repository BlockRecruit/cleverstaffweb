...
//                    console.log(value);
        ...
        } ,
        {
            ...
            binding: function (element, value) {
                if (value == true) {
                    console.log("true");
                    element.append('<i class="male large icon"></i>');
                } else if (value == false) {
                    console.log("true");
                    element.append('<i class="female large icon"></i>');
                }  if (value == null){
                    console.log("true");
                    element.append('<i class="male large icon"></i><i class="female large icon"></i>');
                }
            }
        }
    ];
