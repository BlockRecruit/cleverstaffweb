    ...
    SingleSelect2 = clazz(AbstractSelect2, {
        ...
        createContainer: function () {
            var container = $(document.createElement("div")).attr({
                ...
                "   <span class='select2-chosen'>&#160;</span><abbr class='select2-search-choice-edit-origin'><i class='fa                          fa-pencil'></i></abbr><abbr class='select2-search-choice-delete-origin'></abbr><abbr class='select2-search-choice-close'></abbr>",
        ...
        initContainer: function () {
            ...
            selection.on("mousedown touchstart", "abbr", this.bind(function (e) {
                if (!this.isInterfaceEnabled()) return;
                if(!$(e.currentTarget).hasClass( "select2-search-choice-edit-origin" ) && !$(e.currentTarget).hasClass("select2-search-choice-delete-origin")) {
                    this.clear();
