            ...
            link: function (scope, element, attrs) {
                ...
                function _preview(item, thumb) {
                    ...
                    if (window.FileReader !== null) {
                        ...
                        console.log(reader.readAsDataURL(this._file));
                ...
                //Download files
                function _upload(url, item, permit, $fileScope) {
                    console.log(" function _upload(url, item, permit)");
                    if($fileScope != undefined) {
                        $fileScope.loading = true;
                    }
                    ...
                    console.log("delete item.$preview;");
