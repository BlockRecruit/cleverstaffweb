...
$(document).ready(function(){
    ...
    $(window).scroll(function(){
        ...
        var iphone7 = 375;
        var mini_phone = 320;
        if(window.location.pathname == '/ru/cleverstaff-vs-potok.html' || window.location.pathname == '/ru/cleverstaff-vs-friendwork.html' || window.location.pathname == '/ru/cleverstaff-vs-persia.html' || window.location.pathname == '/ru/cleverstaff-vs-estaff.html'){
            ...
            if(tablet >= $( window ).width()){
                ...
                if(window.location.pathname == '/ru/cleverstaff-vs-potok.html' || window.location.pathname == '/ru/cleverstaff-vs-persia.html'){
                    if (scroll >= 722) {
                        $('.hideTab').addClass('hidden');
                        $('.titleTable').removeClass('fixed-tab');
                    }
                }else if(window.location.pathname == '/ru/cleverstaff-vs-friendwork.html' || window.location.pathname == '/ru/cleverstaff-vs-estaff.html'){
                    if (scroll >= 844) {
                        $('.hideTab').addClass('hidden');
                        $('.titleTable').removeClass('fixed-tab');
                    }
            ...
            if(phone_or_tablet_600 >= $( window ).width()){
                ...
                }else if(window.location.pathname == '/ru/cleverstaff-vs-estaff.html'){
                    if (scroll >= 276){
                        $('.hideTab').removeClass('hidden');
                        $('.titleTable').addClass('fixed-tab');
                    } else{
            ...
            if(window.location.pathname == '/ru/cleverstaff-vs-persia.html'){
            ...
            if(window.location.pathname == '/ru/cleverstaff-vs-estaff.html'){
            ...
            if(mini_phone_335 >= $( window ).width()){
                ...
                } else if(window.location.pathname == '/ru/cleverstaff-vs-persia.html'){
                    if (scroll >= 413){
                        $('.hideTab').removeClass('hidden');
                        $('.titleTable').addClass('fixed-tab');
                    } else{
            ...
            if(window.location.pathname == '/ru/cleverstaff-vs-friendwork.html'){
