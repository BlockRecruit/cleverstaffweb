component.component("navbar", {
    ...
    controller: function navBarController($q, Vacancy, serverAddress, notificationService, $scope, tmhDynamicLocale, $http, Person, $rootScope, Service,
        ...
        vm.$onInit = function () {
            ...
            $rootScope.updateMe = function(noNeedUpdateMe){
                if(noNeedUpdateMe) {
                    update(vm.me);
                } else {
                ...
                function update(response) {
                    ...
                    $rootScope.differenceCreateOrgDate = differenceBetweenTwoDates(new Date(), $rootScope.me.org.dc);
                    $scope.scopeName = $filter('filter')($rootScope.orgs, $scope.orgId, "orgId")[0].orgName;
            ...
            $scope.changeScope = function (name) {
                ...
                if (name == 'region') {
                    if($rootScope.$state.current.data.pageName == 'Candidates'){
...
//    makeCorsRequestNewsEng();
            ...
            //    console.log($rootScope.$state.current.data.pageName);
            //    if ($rootScope.$state.current.data.pageName == 'Candidate') {
            //        if(w.width() < 992){
